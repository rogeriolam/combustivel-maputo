...
import { getAlerts, getCurrentUserProfile, getStations } from "@/lib/supabase/repository";
import { fuelLabels } from "@/lib/domain/config";

export default async function AlertsPage() {
  const [alerts, stations, profile] = await Promise.all([getAlerts(), getStations(), getCurrentUserProfile()]);
